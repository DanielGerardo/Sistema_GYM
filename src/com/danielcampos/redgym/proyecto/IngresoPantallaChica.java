...
/**
 *
 * @author Daniel Gerardo Campos García Class IngresoPantallaChica. Se crea como
 * visualizacion para los clientes del momento en el que ingresan al gym y a la
 * horaActual que salen y ver los productos en venta en una ventana de [1366,
 * 768] Variables: Excritura de camello abreviando su tipo de componente seguido
 * de su nombre de variable Metodos: Exritura de camello (El nombre debe se ser
 * sacado de la funcion que tiene el metodo)
 *
 *
 */
public class IngresoPantallaChica extends javax.swing.JFrame {
    ...
    void cargarTablaProductos() {
        DefaultTableModel model = (DefaultTableModel) visualizarUsario.getModel();
        model.setRowCount(0);
        ...
        try {
            ...
            visualizarUsario.setModel(model);
    ...
    private void initComponents() {
        ...
        visualizarUsario = new rojerusan.RSTableMetro();
        ...
        visualizarUsario.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        visualizarUsario.setColorBackgoundHead(new java.awt.Color(51, 153, 255));
        visualizarUsario.setColorBordeFilas(new java.awt.Color(255, 255, 255));
        visualizarUsario.setColorBordeHead(new java.awt.Color(51, 153, 255));
        visualizarUsario.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        visualizarUsario.setColorFilasForeground1(new java.awt.Color(51, 153, 255));
        visualizarUsario.setColorFilasForeground2(new java.awt.Color(51, 153, 255));
        visualizarUsario.setEnabled(false);
        visualizarUsario.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        visualizarUsario.setFuenteFilas(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        visualizarUsario.setFuenteFilasSelect(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        visualizarUsario.setFuenteHead(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        visualizarUsario.setIntercellSpacing(new java.awt.Dimension(0, 0));
        visualizarUsario.setOpaque(false);
        visualizarUsario.setRowHeight(20);
        jScrollPane1.setViewportView(visualizarUsario);
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Ingreso1GIF.gif"))); // NOI18N
    ...
    /**
     * Este metodo se encarga de buscar al usuario en la BD para que sus datos
     * sean visibles al usuario y verifica si los dias restantes son mayores a 0
     * para dar ingreso si no manda una alearta
     */
    ...
    public String calcularDiasRestantes(String inicio, String fin) {
        int calcular;
        LocalDate currentTime = LocalDate.parse(inicio);
        LocalDate my = LocalDate.parse(fin);

        long periodo = DAYS.between(currentTime, my);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresoPantallaChica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new IngresoPantallaChica().setVisible(true);
        });
    }
    ...
    private rojerusan.RSTableMetro visualizarUsario;
